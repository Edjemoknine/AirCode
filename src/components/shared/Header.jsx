    ...
    <header className="px-2 py-4 border-b">
        ...
        <div className="relative flex flex-wrap items-center justify-between w-full bg-white group py-7 shrink-0">
                    ...
                    <div className="items-center justify-between hidden gap-12 text-black md:flex">
                        ...
                        <Link to={"/Product"} className="[&.active]:font-bold text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900" href="javascript:void(0)">Product</Link>
                    </div>
                    ...
                    <div className={`absolute flex md:hidden transition-all duration-300 ease-in-out flex-col items-start shadow-main justify-center w-full gap-3 overflow-hidden bg-white  py-4 px-4 rounded-2xl ${open?"top-[100%]":"top-[-300%]"} `}>
                        ...
                        <Link to={"/"} className="[&.active]:font-bold text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900" href="javascript:void(0)">Features</Link>
                        <Link to={"/"} className="[&.active]:font-bold text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900" href="javascript:void(0)">Pricing</Link>
